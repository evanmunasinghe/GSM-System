...
export default function BranchAdminDashboard({ tenant, stats = {}, recentVehicles = [] }) {
    return (
        <DashboardLayout title="Branch Admin Panel" workspace={tenant}>
            <section className="dashboard-page-heading">
                <div>
                    <p>Branch administration</p>
                    <h2>Welcome to {tenant?.name || 'FleeV'}</h2>
                </div>
                <span>Manage your branch from one workspace.</span>
            </section>
            ...
            <section className="dashboard-panel">
                ...
                {recentVehicles.length > 0 ? (
                    ...
                    <div className="dashboard-empty-state">
                        No vehicles have been added to Jayarathna Auto yet.
                    </div>
                )}
            </section>
        </DashboardLayout>
